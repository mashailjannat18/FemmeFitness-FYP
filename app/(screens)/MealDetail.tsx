      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.nutrientsContainer}>
          ...
          <View style={styles.categoriesContainer}>
            <Text style={[styles.categoryText, { color: '#8e44ad' }]}>Protein: 25g</Text>
            <Text style={[styles.categoryText, { color: '#e67e22' }]}>Carbs: 40g</Text>
            <Text style={[styles.categoryText, { color: '#16a085' }]}>Fiber: 10g</Text>
          </View>
        </View>
      </View>
    </View>
